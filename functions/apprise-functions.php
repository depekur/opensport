...
function apprise_options_support() { ?>
	<div id="optionsframework-support">
		<div class="metabox-holder">
			<div class="postbox"> 
					<div class="inside">
                        <p class="btn"><a class="button green" target="_blank" href="http://www.vpthemes.com/support/"><?php _e('Theme Support','apprise') ?></a> <a class="button orange" target="_blank" href="http://vpthemes.com/preview/Apprise/"><?php _e('View Demo','apprise') ?></a>
					</div>
			</div>
		</div>
	</div>
