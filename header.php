		...
		<div id="logo-layout">	
			...
			<?php 
				...
				if(class_exists('Woocommerce')) { 
					...
					if (of_get_option('enable_logo_tagline') == '1' ) { ?> 
						<h5 class="site-description"><?php echo bloginfo('description'); ?> <br><a  class="site-mail" href="mailto:info@opensport.ru">info@opensport.ru</a></h5>
					<?php } ?>
