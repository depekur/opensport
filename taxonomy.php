			...
			<div <?php post_class('post-single'); ?>>
				...
				<?php
					...
					<ul class="portfolio-tabs clearfix">
						<li class="active"><a data-filter="*" href="#"><?php echo __('All', 'framework'); ?></a></li>
					...
					<div id="portfolio-wrapper" class="<?php echo of_get_option('portfolio_layout'); ?>">
						...
						<?php query_posts('showposts='.$portfolio_items.'&post_type=portfolio'); ?>	
						...
						?>
							<div class="portfolio-item <?php echo $item_classes; ?> <?php echo of_get_option('portfolio_animation'); ?>">
